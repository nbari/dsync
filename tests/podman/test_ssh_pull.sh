...
$DOCKER exec pxs-server bash -c "mkdir -p /home/devops/Movies && dd if=/dev/urandom of=/home/devops/Movies/test.mkv bs=1M count=100 && chown -R devops:devops /home/devops/Movies"

# Start client and pulling file
echo "Starting client and pulling file..."
# We mount the private key and the pxs binary
